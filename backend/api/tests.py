...
class TournamentsListViewTests(TestCase):
    def setUp(self):
        ...
        # date=2026-08-01, price=20, minimum_age=18, players_on_field=2
        ...
        # date=2026-06-15, price=12, minimum_age=14, players_on_field=6
        Tournament.objects.create(
            name='Torneo Pista',
            field=Field.COURT,
            gender=Gender.MALE,
        ...
        # date=2026-07-10, price=15, minimum_age=16, players_on_field=4
        Tournament.objects.create(
            name='Torneo Nieve',
            field=Field.SNOW,
            gender=Gender.FEMALE,
